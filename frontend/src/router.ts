...
export const router = createRouter({
  ...
  routes: [
    { path: "/", name: "checkin", component: () => import("./views/CheckInView.vue"), meta: { title: "打卡" } },
    ...
    { path: "/activities", name: "activities", component: () => import("./views/ActivitiesView.vue"), meta: { title: "活动" } },
